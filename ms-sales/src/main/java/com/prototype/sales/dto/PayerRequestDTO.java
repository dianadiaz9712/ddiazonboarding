...
public class PayerRequestDTO {
    ...
    @ApiModelProperty(value = "Datos de tarjeta de pago", name = "cardDTO", required = true )
    @NotNull(message = "El campo cardDTO no puede ser nulo")
    @NotEmpty(message = "El campo cardDTO no puede ser vacio")
